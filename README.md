...
```bash
git clone https://github.com/Graciano1997/book_store.git
```
...
Feel free to check the [issues page](https://github.com/Graciano1997/book_store/issues).
